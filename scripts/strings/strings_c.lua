...
--- 角色属性名称
STRINGS.NAMES.KSFUN_POWER_HEALTH         = "血之祭祀"
...
STRINGS.KSFUN_ITEM_ACTIVATE_NOTICE = "%s成功唤醒了%s"
STRINGS.KSFUN_POWER_GAIN_NOTICE    = "%s使用了魔药,成功觉醒了%s"

STRINGS.KSFUN_POTION_ENHANT_SUCCESS = "药剂调制成功!"
...
-------------------------------------------------------------------------- 任务相关字符串----------------------------------------------------------------------------------
STRINGS.NAMES.KSFUN_TASK_BOUNTY = "赏金任务"
