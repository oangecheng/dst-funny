...
ACTIONS_KSFUN_USE_POTION_GENERIC_STR = "使用"
ACTIONS_KSFUN_USE_POTION_STR = "使用"
...
STRINGS.NAMES.KSFUN_POWER_PLAYER_DAMAGE         = "疯狂伤害"
...
STRINGS.KSFUN_TASK_REWARD_POWER     = "%s的运气爆棚,获得了 [%s] 属性奖励" 
